...
1. สร้างเงื่อนไขคำสั่งการเดิน: 
  w = move up (การขยับ positionRow--)
  s = move down (การขยับ positionRow ++)
  a = move left (การขยับ positionCol--)
  d = move right (การขยับ position++)
  if not print "use w, s, d, a"
2. print map; สร้าง สนามโดยทำการลูป1ครั้งเพื่อสร้างจำนวนแถว และลูปซ้อนกันอีกครั้งเพื่อตต้องการให้ขึ้นแถวใหม่ แล้วเติมค่า fieldCharacter ลงไป กำหนดให้ตำแหน่งผู้เล่นเกิดที่ [0][0] สุ่่มการเกิดหมวก และหลุมโดยการใช้ do..while สุ่มตามแถวกับหลักโดยที่ ห้ามทับตำแหน่งที่ [0, 0]และไม่ทับกันเอง
3. เงื่อนไขการเล่น
ชนะ: เมื่อผู้เล่นเดินไปเก็บหมวกได้
แพ้: 1.เมื่อผู้เล่นตกหลุม 2.เมื่อผู้เล่นเดินออกสนาม
4. อัปเดตสนามเมื่อทำการสั่งเดินของผู้เล่น
